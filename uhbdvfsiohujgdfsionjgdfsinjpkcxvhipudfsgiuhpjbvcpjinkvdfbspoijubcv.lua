...
local library = {
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'Midnight';
    gamename = startupArgs.gamename or 'Trident Survival V5';
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "Ak3_s"})
    creditsSection:AddSeparator({text = 'Helpers'});
    creditsSection:AddText({text = "Magnetas"})
    creditsSection:AddText({text = "Elytas"})
